    ...
    public function scaffoldRealtimeApp(
        ...
        $steps = $this->runner->run([
            ...
            [
                ...
                'phase' => 'scaffold',
                'tool' => 'sockeon_scaffold_controller',
            ...
            [
                ...
                'phase' => 'realtime',
                'tool' => 'sockeon_realtime_websocket_handler',
    ...
    public function hardenProductionServer(): array
    {
        $steps = $this->runner->run([
            [
                ...
                'phase' => 'security',
                'tool' => 'sockeon_config_rate_limit',
                'args' => ['enabled' => true],
            ],
            [
                'id' => 'cors',
            ...
            [
                ...
                'phase' => 'security',
                'tool' => 'sockeon_security_authentication',
                'args' => ['authType' => 'token'],
            ],
            [
                'id' => 'logger',
                ...
                'phase' => 'observability',
                'tool' => 'sockeon_observability_logging_setup',
                'args' => [],
            ],
        ]);
